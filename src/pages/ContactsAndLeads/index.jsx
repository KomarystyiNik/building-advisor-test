        ...
        <div className="flex justify-between mb-5">
          ...
          <div className="w-130 rounded-xl bg-white flex flex-col justify-end items-end px-7 py-8">
            ...
            <p className="text-sm text-grey-200 mt-7 mb-7 w-85">
              Your building`s projected value is a 3x multiple of annual
              building net income. This assumes continued ownership and
              marketing of the building for three years
            </p>
          ...
          <div className="w-3.2/10 px-8 py-5 bg-white rounded-lg">
            <div className="mb-5">
              ...
              <div className="flex items-center">
                <span className="text-5xl text-blue-400 font-bold mr-7">
                  123
                </span>
